 ...
 * The caller must be preallocate a number of slots that is given in \p *nr on input.
 *
 * \param nr A pointer to the number of ports.
 ...
 * \param The corresponding map server returned on success.
 *
 * \returns 0 on success
 */
